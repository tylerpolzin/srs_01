...
// START Callsheets 'EDIT' JS
    ...
    $(function(){
        $('#genieNotes').val($('#genieNotesHidden').val());
    });
    // END Genie 'EDIT' JS
    ...
    $(function(){
        $('#summitNotes').val($('#summitNotesHidden').val());
    });
    // END Summit 'EDIT' JS
    ...
    $(function(){
        $('#allstoneNotes').val($('#allstoneNotesHidden').val());
    });
    $(function(){
        $('#tuscanyNotes').val($('#tuscanyNotesHidden').val());
    });
...
// Start Callsheets 'NEW' JS
    ...
    $(function() {
        ...
        $( "#submitConfirm" ).dialog({autoOpen: false, resizable: false, height: "auto", width: 400, modal: true,
              buttons: {
                "Submit": function() {
                  $( this ).dialog( "close" );
    ...
    $(function() {
        ...
        $( "#saveConfirm" ).dialog({autoOpen: false, resizable: false, height: "auto", width: 400, modal: true,
              buttons: {
                "OK": function() {
                  $( this ).dialog( "close" );
    ...
    $('#allstoneNotes').keyup(function() {
        $("#allstoneNotesHidden").val($("#allstoneNotes").val()).change();})
    $('#tuscanyNotes').keyup(function() {
